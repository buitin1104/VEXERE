...
export default function DetailPage() {
    ...
    return (
      <div className="flex w-full flex-grow flex-row overflow-x-auto border-b-1 border-grey-200">
        <Button
          variant="ghost"
          className={cn(
            'h-20 min-w-32 flex-grow rounded-none border-0 border-b-3 border-b-cyan-dark',
            '',
          )}
        ...
        <Button
          variant="ghost"
          className={cn(
            'h-20 min-w-32 flex-grow rounded-none border-none',
            activeSection === infoRef,
          )}
        ...
        <Button
          variant="ghost"
          className={cn(
            'h-20 flex-grow rounded-none border-none',
            activeSection === amenityRef,
          )}
  ...
  function Overview() {
    return (
      <div ref={overviewRef} className="my-5">
        <div className="flex items-start justify-between overflow-scroll">
          <div className="w-3/4 min-w-[300px]">
            ...
            <p className="mb-4">
              Bạn có thể đủ điều kiện hưởng giảm giá Genius tại Temple Da Nang
              Resort. Để biết giảm giá Genius có áp dụng cho ngày bạn chọn hay
              không, hãy{' '}
              <span className="text-blue-600 underline">đăng nhập</span>.
            </p>
            <p className="mb-4">
              Giảm giá Genius tại chỗ nghỉ này chỉ thuộc vào ngày đặt phòng,
              ngày lưu trú và các ưu đãi có sẵn khác.
            </p>
            <p className="mb-4">
              Nằm trên Bãi biển Mỹ Khê, Temple Da Nang Resort cung cấp chỗ nghỉ
              với Wi-Fi miễn phí và tầm nhìn ra biển. Tại đây cũng có hồ bơi
              ngoài trời và nhà hàng.
            </p>
            <p className="mb-4">
              Temple Da Nang Resort cách trung tâm thành phố Đà Nẵng 2 km, sân
              bay quốc tế Đà Nẵng 10 phút lái xe và Núi Ngũ Hành Sơn 8 km.
            </p>
            <p className="mb-4">
              Các phòng nghỉ tại đây đều được hoàn thiện với đồ kết an toàn
              trong phòng, truyền hình cáp màn hình phẳng, tủ lạnh mini và máy
              điều hòa nhiệt độ. Một số phòng nghỉ có bồn tắm và vòi sen hoặc
              phòng tắm riêng biệt. Tất cả các phòng đều có dép, máy sấy tóc và
              đồ vệ sinh cá nhân miễn phí. Các phòng nghỉ tại đây đều có ban
              công riêng.
            </p>
            <p className="mb-4">
              Tại Temple Da Nang Resort, du khách có thể thư giãn tại khu vực
              bãi biển riêng, phòng tắm nắng hoặc vườn. Các hoạt động như lặn
              biển, lướt ván buồm, chèo thuyền kayak và lặn với ống thở cũng có
              thể được sắp xếp tại đây. Du khách có thể tham gia các hoạt động
              như múa bụng, múa lửa và nhạc sống. Tại đây cũng có dịch vụ đưa
              đón có tính phí và dịch vụ giữ hành lý.
            </p>
            <p className="mb-4">
              Các cặp đôi đặc biệt thích địa điểm này — họ cho điểm 8,8 khi đi
              du lịch hai người.
            </p>
          </div>
        ...
        <div className="flex w-full flex-row justify-between">
          ...
          <div className="min-w-[400px]">
            <h2 className="mb-2 w-full text-xl font-bold">
                    ...
                    <ul className="text-sm">
                      {room.options.map((option, i) => (
                        <li
                          key={i}
                          className={
                            option.includes('Chỉ còn') ? 'text-red-600' : ''
                          }
                        >
                          {option}
                        </li>
      ...
      <div className="mb-4 flex w-full flex-row rounded-lg bg-white p-4 shadow">
        ...
        <div className="mt- flex-1">
          <div className="flex items-center justify-between">
            ...
            <div className="rounded bg-blue-600 px-2 py-1 text-sm font-bold text-white">
              {review.rating}
            </div>
          </div>
  ...
  function CommentList() {
    return (
      <div ref={commentsRef} className="mx-auto mt-20 w-full">
  ...
  function Amenity({ selectedIds }) {
    return (
      <div ref={amenityRef} className="my-10 flex flex-col">
        ...
        <div className="flex flex-row flex-wrap gap-[30px]">
          {amenitiesConst.map((amenity) => {
            if (selectedIds.includes(amenity.id)) {
              return (
                <div key={amenity.id} className="w-[320px]">
                  <div className="flex items-center gap-2">
                    {amenity.icon()}
                    <p
                      className={cn(
                        'text-lg',
                        selectedIds.includes(amenity.id) && 'font-bold',
                      )}
                    >
                      {amenity.title}
                    </p>
  ...
  function PolicyRender() {
    return (
      <div ref={policyRef} className="mx-auto my-20 w-full rounded-lg bg-white">
        ...
        <div className="mb-4 rounded-lg border p-4 shadow-md">
          ...
          <div className="mb-4 flex">
            ...
            <div>
              <p>
                Các chính sách hủy và thanh toán trước sẽ khác nhau tùy vào loại
                chỗ nghỉ. Vui lòng kiểm tra{' '}
          ...
          <div className="mb-4 flex">
            ...
            <div>
              ...
              <p>
                Trẻ em từ 6 tuổi trở lên sẽ được tính giá như người lớn tại chỗ
                nghỉ này.
              </p>
              <p>
                Để xem thông tin giá và tình trạng phòng trống chính xác, vui
                lòng thêm số lượng và độ tuổi của trẻ em trong nhóm của bạn khi
                tìm kiếm.
              </p>
            </div>
          </div>
  ...
  function NoteRender({ note }) {
    if (note)
      return (
        <div ref={noteRef} className="my-10 flex flex-col">
